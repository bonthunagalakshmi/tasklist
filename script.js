...
const taskInput = document.querySelector("#newtask input"); const taskSection = document.querySelector('.tasks');
...
document.querySelector('#push').onclick = function () {
    ...
    alert("The task field is blank. Enter a task name and try again."); }    
        ...
        //this block inserts HTML that creates each task into the task area div eleme 
